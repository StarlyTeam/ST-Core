...
public class LocaleWrappers {
    ...
    public enum EnchantmentWrapper {
        DAMAGE_ALL("날카로움", "Sharpness", Enchantment.DAMAGE_ALL),
        ARROW_DAMAGE("힘", "Power", Enchantment.ARROW_DAMAGE),
        ARROW_FIRE("화염", "Flame", Enchantment.ARROW_FIRE),
        ARROW_INFINITE("무한", "Infinity", Enchantment.ARROW_INFINITE),
        ARROW_KNOCKBACK("밀어내기", "Punch", Enchantment.ARROW_KNOCKBACK),
        BINDING_CURSE("귀속 저주", "Binding Curse", Enchantment.BINDING_CURSE),
        CHANNELING("집전", "Channeling", Enchantment.CHANNELING),
        DAMAGE_ARTHROPODS("살충", "Bane Of Arthropods", Enchantment.DAMAGE_ARTHROPODS),
        DAMAGE_UNDEAD("강타", "Smite", Enchantment.DAMAGE_UNDEAD),
        DEPTH_STRIDER("물갈퀴", "Depth Strider", Enchantment.DEPTH_STRIDER),
        DIG_SPEED("효율", "Efficiency", Enchantment.DIG_SPEED),
        DURABILITY("내구성", "Unbreaking", Enchantment.DURABILITY),
        ...
        LOOT_BONUS_MOBS("약탈", "Looting", Enchantment.LOOT_BONUS_MOBS),
        LOYALTY("충절", "Loyalty", Enchantment.LOYALTY),
        LUCK("바다의 행운", "Luck Of Sea", Enchantment.LUCK),
        Lure("미끼", "Lure", Enchantment.LURE),
        MENDING("수선", "Mending", Enchantment.MENDING),
        MULTISHOT("다중발사", "Multishot", Enchantment.MULTISHOT),
        OXYGEN("호흡", "Respiration", Enchantment.OXYGEN),
        PIERCING("관통", "Piercing", Enchantment.PIERCING),
        PROTECTION_ENVIRONMENTAL("보호", "Protection", Enchantment.PROTECTION_ENVIRONMENTAL),
        PROTECTION_EXPLOSIONS("폭발로부터 보호", "Blast Protection", Enchantment.PROTECTION_EXPLOSIONS),
        PROTECTION_FALL("가벼운 착지", "Feather Falling", Enchantment.PROTECTION_FALL),
        PROTECTION_FIRE("화염으로부터 보호", "Fire Protection", Enchantment.PROTECTION_FIRE),
        PROTECTION_PROJECTILE("발사체로부터 보호", "Projectile Protection", Enchantment.PROTECTION_PROJECTILE),
...
//        SWIFT_SNEAK("신속한 잠행", "Swift Sneak", Enchantment.SWIFT_SNEAK),
        ...
        WATER_WORKER("친수성", "Aqua Affinity", Enchantment.WATER_WORKER);
